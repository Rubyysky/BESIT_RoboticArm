...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">B.E.S.I.T</h1>
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr/><tr/>      
      <tr>
        <td style="text-align:left;font-size:25px"><b>Elbow-2:</b></td>
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="180" value="90" class="slider" id="Elbow-2" oninput='sendButtonInput("Elbow-2",value)'>
          </div>
        </td>
      </tr>
      <tr/><tr/>
    ...
    <script>
      ...
      function enableDisableButtonsSliders(button)
      {
        if(button.id == "Play")
        {
          ...
          document.getElementById("Elbow-2").style.pointerEvents = disabled;          
